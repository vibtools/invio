...
class RepositoryContractTests(unittest.TestCase):
    def test_release_metadata_is_v100141(self):
        ...
        self.assertIn('version = "1.0.0.1.41"', pyproject)
        self.assertIn('"version": "1.0.0.1.41"', project_meta)
        self.assertIn('"latestVersion": "1.0.0.1.41"', project_meta)
        self.assertIn('"current": "1.0.0.1.41"', docs_meta)
        self.assertIn('"latest": "1.0.0.1.41"', docs_meta)
        self.assertIn('Production • v1.0.0.1.41', main_window)
        self.assertIn('Invio/1.0.0.1.41', runtime)
    ...
    def test_v100136_ci_correction_and_certification_truthfulness(self):
        ...
        self.assertIn('INVIO_VERSION: "1.0.0.1.41"', workflow)
        self.assertIn('INVIO_PE_VERSION: "1.0.1.41"', workflow)
        self.assertIn("P14 CERTIFICATION PENDING", roadmap)
        self.assertIn("Production-ready: NO", release)
    ...
    def test_v100141_providers_page_compact_ui_truthfulness(self):
        ...
        self.assertIn('INVIO_VERSION: "1.0.0.1.41"', workflow)
        self.assertIn('INVIO_PE_VERSION: "1.0.1.41"', workflow)
        self.assertIn('PROVIDER_CARD_HEIGHT = 220', page)
        self.assertIn('PROVIDER_CARD_MIN_WIDTH = 280', page)
        self.assertIn('PROVIDER_GRID_GAP = 16', page)
        self.assertIn('PROVIDER_MIN_COLUMNS = 2', page)
        self.assertIn('PROVIDER_MAX_COLUMNS = 4', page)
        self.assertIn('"ProviderLogoPlaceholder"', page)
        self.assertIn('"ProviderCapabilityChip"', page)
        self.assertIn('layout.addStretch(1)', page)
        self.assertIn('QPushButton#ProviderLoadButton', styles)
        self.assertIn("background: {c['nested_surface']};", styles)
