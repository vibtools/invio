...
class RepositoryContractTests(unittest.TestCase):
    ...
    def test_release_metadata_is_v100110(self):
        ...
        self.assertIn('version = "1.0.0.1.10"', pyproject)
        self.assertIn('"version": "1.0.0.1.10"', project_meta)
        self.assertIn('"latestVersion": "1.0.0.1.10"', project_meta)
        self.assertIn('"keyring>=25.7,<26"', project_meta)
        self.assertIn('Production • v1.0.0.1.10', main_window)
        self.assertIn('Invio/1.0.0.1.10', runtime)

    def test_release_metadata_is_v10019(self):
        """Compatibility alias retained under the no-removal baseline contract."""
        self.test_release_metadata_is_v100110()
