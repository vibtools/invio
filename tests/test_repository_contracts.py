...
class RepositoryContractTests(unittest.TestCase):
    ...
    def test_release_metadata_is_v100117(self):
        ...
        self.assertIn('version = "1.0.0.1.17"', pyproject)
        self.assertIn('"version": "1.0.0.1.17"', project_meta)
        self.assertIn('"latestVersion": "1.0.0.1.17"', project_meta)
        self.assertIn('"keyring>=25.7,<26"', project_meta)
        self.assertIn('Production • v1.0.0.1.17', main_window)
        self.assertIn('Invio/1.0.0.1.17', runtime)
