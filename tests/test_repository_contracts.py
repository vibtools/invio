...
class RepositoryContractTests(unittest.TestCase):
    def test_release_metadata_is_v100141(self):
        ...
        self.assertIn('version = "1.0.0.1.49.2"', pyproject)
        self.assertIn('"version": "1.0.0.1.49.2"', project_meta)
        self.assertIn('"latestVersion": "1.0.0.1.49.2"', project_meta)
        self.assertIn('"current": "1.0.0.1.49.2"', docs_meta)
        self.assertIn('"latest": "1.0.0.1.49.2"', docs_meta)
        self.assertIn('Production • v1.0.0.1.49.2', main_window)
        self.assertIn('Invio/1.0.0.1.49.2', runtime)
    ...
    def test_v100136_ci_correction_and_certification_truthfulness(self):
        ...
        self.assertIn('INVIO_VERSION: "1.0.0.1.49.2"', workflow)
        self.assertIn('INVIO_PE_VERSION: "1.0.1.4902"', workflow)
        self.assertIn("P14 CERTIFICATION PENDING", roadmap)
        self.assertIn("Production-ready: NO", release)
...
class V1492ProviderEasyOnboardingCompatibilityReleaseContractTests(unittest.TestCase):
    def test_v1492_identity_scope_and_root_cause_are_truthful(self):
        ...
        self.assertIn('official current baseline', manifest.casefold())
