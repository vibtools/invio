...
class UiContractTests(unittest.TestCase):
    ...
    def test_provider_cards_use_official_plugin_visual_contract(self):
        ...
        self.assertIn('"ProviderLogoPlaceholder"', page_source)
        ...
        self.assertIn('"ProviderCapabilityChip"', page_source)
        self.assertIn('"ProviderMeta"', page_source)
        ...
        self.assertIn('QLabel#ProviderLogoPlaceholder', style_source)
        self.assertIn('QLabel#ProviderCapabilityChip', style_source)
