...
class UiContractTests(unittest.TestCase):
    ...
    def test_provider_cards_use_official_plugin_visual_contract(self):
        ...
        style_source = (root / "src" / "ui" / "styles.py").read_text(encoding="utf-8")
        pyproject = (root / "pyproject.toml").read_text(encoding="utf-8")
        self.assertIn('PROVIDER_CARD_HEIGHT = 188', page_source)
        self.assertIn('PROVIDER_CARD_MIN_WIDTH = 280', page_source)
        self.assertIn('PROVIDER_CARD_PADDING = 14', page_source)
        self.assertIn('PROVIDER_GRID_GAP = 12', page_source)
        ...
        self.assertIn('PROVIDER_MAX_COLUMNS = 3', page_source)
