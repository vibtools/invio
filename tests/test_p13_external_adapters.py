...
""",
    ...
    def test_providers_ui_reports_runtime_adapter_state_and_trusted_code_guards(self):
        ...
        self.assertIn('f"Runtime: {adapter_status} • {credential_count} {credential_word}"', providers_page)
        self.assertIn('runtime_label.setToolTip(', providers_page)
        self.assertIn('adapter_message,', providers_page)
