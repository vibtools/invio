...
Current pages in `v1.0.0.1.23` are Dashboard, Accounts, Invoice Templates, Customer Lists, Tasks, Providers, Reports, Live Logs, and Settings. P08 adds no page or layout change.
