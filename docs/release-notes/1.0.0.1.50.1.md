...
- Advance release identity only to application/wheel `1.0.0.1.50.1`, PE `1.0.1.5001`, MSI `1.1.5001`, and tag `v1.0.0.1.50.1`.
...
Tag `v1.0.0.1.50.1` and GitHub Release `Invio v1.0.0.1.50.1` were published on 2026-08-18 with the Python wheel, Windows x64 portable ZIP, Windows x64 MSI, and release `SHA256SUMS.txt`. Later repository-maintenance phases do not modify those published release artifacts or reopen Phase 1–4 runtime behavior.
