...
- `release-notes/1.0.0.1.19.md` - current release.
...
`v1.0.0.1.19` is the verified **P07 - Task State Machine and Resend Safety** baseline. Production progress is **7/14**. The next separately approval-gated phase is **P08 - Worker and Network Reliability**.
